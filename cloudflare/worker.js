// Cloudflare Worker (ES Module Format) for Cloudflare Dashboard Editor
// Copy and paste this code into worker.js in your Cloudflare Dashboard
    ...
    try {
      ...
      if (url.pathname === '/' && request.method === 'GET') {
        return new Response(
          JSON.stringify({
            success: true,
            message: 'ApniCar Cloudflare D1 Backend API is active',
          }),
      ...
      if (url.pathname === '/api/register' && request.method === 'POST') {
        ...
        // 3. Check for Duplicate Phone Number using D1 Prepared Statement
        ...
        // 5. Insert User into Cloudflare D1 (env.DB)
